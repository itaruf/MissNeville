...
struct DCharlotte 
{
	...
	// Room
	std::string r1{ "[Charlotte Neville] says : My mirror, you repaired it and made her disappear ! Serves her right once again, haha !" };

	// Library
	std::string l1{ "[Charlotte Neville] says : Father, you always were living for and by the books.. You would always tell others how precious were your books but you would never care for me.. Until I did." };
...
{
	// Kitchen
	std::string k1{ "[Anne Neville] says : How could a mother be blind to the pain of their own child ..? This eternal punishment should be mine... But they decided to make it yours now..! You cannot escape this anymore..!" };
};
